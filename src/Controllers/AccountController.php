...
class AccountController extends BaseController {
    ...
    /**
     * Payin
     * @param  Models\PayinServiceModel $model               Required parameter: Example: 
     * @param  string                $acceptLanguage      Optional parameter: Example: fr
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createAccountPayIn (
                $model,
                $acceptLanguage = 'fr') 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getAccountGetWallet () 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
    ...
    /**
     * Create new account
     * @param  Models\AccountWriterServiceModel $acc                 Required parameter: Example: 
     * @param  string                        $acceptLanguage      Optional parameter: Example: fr
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createAccountCreateAccount (
                $acc,
                $acceptLanguage = 'fr') 
    {
        //the base uri for api requests
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($acc));
