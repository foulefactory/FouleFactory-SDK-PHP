...
class CsvFilesController extends BaseController {
    ...
    /**
     * @var CsvFilesController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return CsvFilesController The *Singleton* instance.
     */
    ...
    /**
     * Create new csv file
     * @param  Models\CsvFileWriterServiceModel $file                Required parameter: Example: 
     * @param  string                        $acceptLanguage      Optional parameter: Example: fr
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createCsvFilesCreateCsvFile (
                $file,
                $acceptLanguage = 'fr') 
    {
        ...
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($file));
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getCsvFilesGet (
                $id,
                $acceptLanguage = 'fr') 
    {
        //the base uri for api requests
