...
class ProjectsController extends BaseController {
    ...
    /**
     * @var ProjectsController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return ProjectsController The *Singleton* instance.
     */
    ...
    /**
     * Create new project
     * @param  Models\ProjectWriterServiceModel $project             Required parameter: Example: 
     * @param  string                        $acceptLanguage      Optional parameter: Example: fr
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createProjectsCreateProject (
                $project,
                $acceptLanguage = 'fr') 
    {
        ...
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($project));
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getProjectsGetUserProjects () 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getProjectsGetProjectFiles (
                $id,
                $acceptLanguage = 'fr') 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getProjectsGetProjectTaskLines (
                $id,
                $acceptLanguage = 'fr') 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getProjectsGetProjectTasks (
                $id,
                $acceptLanguage = 'fr') 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getProjectsGet (
                $id,
                $acceptLanguage = 'fr') 
    {
        //the base uri for api requests
