 ...
 */
class TaskAnswerChoicesController extends BaseController {

    /**
     * @var TaskAnswerChoicesController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return TaskAnswerChoicesController The *Singleton* instance.
     */
     ...
     */
    public function getTaskAnswerChoicesGet (
                $id,
                $acceptLanguage = 'fr') 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/v1.1/taskAnswerChoices/{id}';
