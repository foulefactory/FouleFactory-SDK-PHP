 ...
 */
class TaskAnswerTextsController extends BaseController {

    /**
     * @var TaskAnswerTextsController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return TaskAnswerTextsController The *Singleton* instance.
     */
     ...
     */
    public function getTaskAnswerTextsGet (
                $id,
                $acceptLanguage = 'fr') 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/v1.1/taskAnswerTexts/{id}';
